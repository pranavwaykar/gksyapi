...
// Feature icons (bottom) - Commercial specific features
const features = [
  {
    icon: "conference",
    label: "Конференц-зал"
...
const CommercialProjects = () => {
  const project = {
    ...
    type: 'Коммерческий комплекс из клееного бруса',
    specs: {
      area: '1200 м2',
      floors: '2',
  ...
  React.useEffect(() => {
    document.documentElement.style.setProperty(
      '--bg-image',
      `url("https://images.unsplash.com/photo-1545163590-180b37f5c1e5?q=80&w=3135&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")`
    );
    ...
    <div className="project-viewer">
      <div className="project-card">
        <div className="project-main">
          ...
          <img 
            src="https://images.unsplash.com/photo-1545163590-180b37f5c1e5?q=80&w=3135&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" 
            alt={project.name} 
