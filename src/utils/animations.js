...
export const setupHomeVerticalTextAnimation = () => {
  ...
  if (primaryText) {
    ...
    gsap.set(primaryText, { opacity: 0, scale: 0.8, y: 80, filter: 'blur(20px)' });
  }
  
  if (secondaryText) {
    textElements.push(secondaryText);
    gsap.set(secondaryText, { opacity: 0, scale: 0.8, y: 80, filter: 'blur(20px)' });
  }
  ...
  tl.to(line, {
    ...
    duration: 1.2,
    ease: 'power3.inOut',
    boxShadow: '0 0 25px rgba(255, 255, 255, 0.9), 0 0 50px rgba(0, 150, 255, 0.7)',
    onStart: () => {
  ...
  if (secondaryText) {
    tl.to(secondaryText, {
      ...
      onComplete: () => {
        ...
        gsap.to(line, {
          boxShadow: '0 0 30px rgba(255, 255, 255, 0.9), 0 0 50px rgba(0, 150, 255, 0.7)',
          duration: 2,
          ease: 'sine.inOut',
          yoyo: true,
          repeat: -1
